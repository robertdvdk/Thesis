...
class WGAN():
    def __init__(self, device, batch_size=64, lr=0.00001, num_epochs=1000, seq_len=100, data_dir='/home/klis004/nbk_lustre/gan_input/gan_data_2ediff.txt', \
        run_name='test', hidden=512, d_steps = 5):
        self.device = device
        self.hidden = hidden
        # self.hidden = 256
        self.batch_size = batch_size
        ...
        self.g_steps = 1
        self.lamda = 10
        self.checkpoint_dir = '/home/klis004/nbk_lustre/gan/checkpoint/' + run_name + '/'
        self.sample_dir = '/home/klis004/nbk_lustre/gan/samples/' + run_name + '/'
    ...
    def calc_gradient_penalty(self, real_data, fake_data):
        # Vraag: deze functie snap ik niet zo goed. Wat doet de alpha precies?
        # Wat doen de interpolates? En waarom hebben we autograd.grad nodig
        # in plaats van 'gewoon' een loss berekenen en die propageren door het
        # netwerk?
    ...
    def train_model(self, load_dir):
        ...
        for epoch in range(self.num_epochs):
            ...
            for idx in range(n_batches):
                ...
                # Wasserstein uitleg nog even goed lezen om de loss te snappen
...
def main():
    ...
    model = WGAN(device=device, run_name='realmode_smol', hidden=128)
